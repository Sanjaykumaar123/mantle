...
const recordingSteps = [
  {
    ...
    narration:
      "Ini adalah AEGIS AI. Fokusnya adalah transfer aset RWA secara confidential, tapi tetap audit-ready dengan layer intelligence yang menjelaskan setiap insight.",
  },
  {
    scene: "Scene 2",
